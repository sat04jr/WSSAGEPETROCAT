...
ResumenCliente.RazonSocial, ResumenCliente.Domicilio, ResumenCliente.CodigoPostal, ResumenCliente.CodigoMunicipio, ResumenCliente.Municipio, ResumenCliente.FormadePago, ResumenCliente.NumeroPlazos, 
ResumenCliente.DiasPrimerPlazo, ResumenCliente.DiasEntrePlazos, ResumenCliente.DiasFijos1, ResumenCliente.DiasFijos2, ResumenCliente.IndicadorIva, ResumenCliente.IvaIncluido, ResumenCliente.ObservacionesCliente, 
...
$where = "(BLM_DatosNif.BLM_CodigoClienteHeptan <> '' AND ResumenCliente.CodigoEmpresa = 3) AND (ResumenCliente.FechaFactura >= CONVERT(DATETIME, 
...
$where2 = "(BLM_DatosNif.BLM_CodigoClienteHeptan <> '' AND ResumenCliente.CodigoEmpresa = 3) AND (ResumenCliente.FechaFactura < CONVERT(DATETIME, 
...
function groupAlbaranes($data, $tablasQuery) {
    ...
    foreach ($data as $key => $factura) {
        $data[$key]['Albaranes'] = [];
        $albaranesWhere = "EjercicioFactura = " .$factura['EjercicioFactura'] ." AND SerieFactura = '" .$factura['SerieFactura'] ."' AND NumeroFactura = " .$factura['NumeroFactura'];
