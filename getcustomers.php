...
$select = "Clientes.CodigoCliente, Clientes.SiglaNacion, BLM_DatosNif.CifDni, Clientes.CifEuropeo, Clientes.FechaAlta, Clientes.CodigoContable, Clientes.RazonSocial, Clientes.Nombre, 
                         ...
                         ClientesProveedores.Provincia AS ProvinciaFiscal, Clientes.FormadePago, 
                         Clientes.IBAN, Bancos.BIC, Clientes.IndicadorIva, Clientes.ObservacionesCliente, Clientes.AgruparAlbaranes, Clientes.Telefono, Clientes.Telefono2, Clientes.Fax, Clientes.EMail1, 
                         Clientes.BajaEmpresaLc, Clientes.FechaBajaLc, Clientes.CodigoMotivoBajaClienteLc, BLM_DatosNif.CodigoTipoClienteLc, Clientes.PersonaClienteLc, 
                         Clientes.EnvioEFactura, Clientes.EmailEnvioEFactura, 
                         ...
                         DF.Municipio AS MunicipioFactura, DF.Provincia AS ProvinciaFactura";
...
if(mssql_num_rows($registro)==0) {
	...
	if(isset($cifDni)) {
		print_json(404, "No data found. " .error_get_last()['message'] .'. ' .error_get_last()['file'] .'. ' .error_get_last()['line'], null);
